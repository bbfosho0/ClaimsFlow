  ...
  return {
    beforeMutation: [
      ...
      scenario(
        ...
        ['Operational Analytics', 'Regional distribution'],
        desktop,
      ...
      scenario(
        ...
        ['Team Operations', 'Selected workload utilization'],
        desktop,
        { expectedQuery: { role: 'manager' } },
      ),
      scenario(
        ...
        ['Team Operations', 'Operational integrity score'],
        desktop,
      ...
      scenario(
        ...
        ['Evidence Operations', 'Evidence categories'],
        desktop,
