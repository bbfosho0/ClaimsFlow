  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        data: shell('Documents & Communications', 'Evidence, OCR, messages, and collaborative review.'),
      },
      {
        path: 'team-ops',
        ...
        data: shell('Team Operations & SLA', 'Capacity, ownership, escalations, and service health.'),
      },
      {
        path: 'workflows',
        ...
        data: shell('Workflow Automation', 'Rules, simulations, approvals, and audit-safe orchestration.'),
      },
      {
        path: 'reports',
